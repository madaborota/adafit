          ...
          <div className="card h-100 shadow-sm border-0 rounded-4 p-2">
            ...
            <div className="card-body d-flex flex-column justify-content-between">
              ...
              <div className="d-flex flex-column flex-md-row align-items-md-center justify-content-between mt-3">
                <span className="fw-semibold text-dark" style={{fontSize: '1rem'}}>de la 100 RON</span>
        ...
        <div className="col-md-4">
          <div className="card h-100 shadow-sm border-0 rounded-4 p-2">
            ...
            <div className="card-body d-flex flex-column justify-content-between">
              ...
              <div className="d-flex flex-column flex-md-row align-items-md-center justify-content-between mt-3">
                <span className="fw-semibold text-dark" style={{fontSize: '1rem'}}>de la 150 RON</span>
                <button className="btn btn-dark btn-sm rounded-pill mt-2 mt-md-0 px-3">Detali</button>
              </div>
            </div>
          </div>
